...
const STATUS_CONFIG: Record<
  string,
  { label: string; color: string; progress: number; pulse?: boolean }
> = {
  pending: {
    label: "قيد الانتظار",
    color: "#f39c12",
...
export default function OrdersList() {
  ...
  // if(orders.length === 0 ) return <Typography>لا يوجد طلبات </Typography>
  ...
  return (
    <Box sx={{ bgcolor: "#F8F9FA", minHeight: "100vh", py: 5 }}>
      <Container maxWidth="sm">
        ...
        {orders.length === 0 && <Typography>لا يوجد طلبات !</Typography>}
